...
extension Notification.Name {
    ...
    static let hitermSwipeBegan = Notification.Name("hitermSwipeBegan")
    static let hitermSwipeMoved = Notification.Name("hitermSwipeMoved")
    static let hitermSwipeEnded = Notification.Name("hitermSwipeEnded")
